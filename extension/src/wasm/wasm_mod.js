 ...
 * @returns {number}
 */
export function average_luma_in_nits_from_data_uri(uri) {
	...
	const len0 = WASM_VECTOR_LEN;
	const ret = wasm.average_luma_in_nits_from_data_uri(ptr0, len0);
	return ret;
}
 ...
 * @returns {number}
 */
export function estimate_saved_energy_mwh_from_data_uri(
	display_width,
	display_height,
	hours,
	tech,
	...
	const len0 = WASM_VECTOR_LEN;
	const ret = wasm.estimate_saved_energy_mwh_from_data_uri(
		display_width,
		display_height,
		hours,
		tech,
